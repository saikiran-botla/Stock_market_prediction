...
class gru:
    def __init__(self,lr,time_step):
        ...
        self.model.add(GRU(128,input_shape=(time_step,1),return_sequences=True))
    ...
    def save_model(self):
        self.model.save('./models/GRU')

    def load_model(self):
        self.model=tensorflow.keras.models.load_model('./models/GRU')
